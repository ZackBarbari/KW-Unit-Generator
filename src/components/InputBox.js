	...
	return (
		<div className='section-box'>
			<div className='basic-box'>
				<InputForm label='Name' ref={nameRef} passedValue={defaults.name} onChange={onSave} />
				<InputForm label='Commander' ref={commandRef} passedValue={defaults.commander} onChange={onSave} />
			...
			<div className='trait-box'>
				...
				<ArrayReadingDropdown label='Add Trait' ref={traitRef} passedOptions={traits} invalid={traitList.length >= 4} />
				{traitList.length < 4 && <input type='submit' value='Add Trait' onClick={addTrait} />}
			</div>
			{raceRef.current.value === 'Other' && 'INPUT YOUR OWN RACIAL VALUES'}
		</div>
	);
};
